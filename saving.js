...
document.getElementById('form').addEventListener('submit', async (e) => {
  ...
  const eurVal = parseFloat(document.getElementById('eur').value) || null
...
div.innerHTML = `
  ...
  <div class="tx-details">
    <div><strong>EUR:</strong> ${t.eur_amount ? `${t.eur_amount} €` : '-'}</div>
